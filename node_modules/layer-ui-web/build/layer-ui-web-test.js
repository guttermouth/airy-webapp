...
},{"./lib/adapters/angular":2,"./lib/adapters/backbone":3,"./lib/adapters/react":4,"./lib/components/conversation-list-panel/layer-conversations-list/layer-conversations-list":8,"./lib/components/identities-list-panel/layer-identities-list/layer-identities-list":9,"./lib/components/layer-conversation-panel/layer-conversation-panel":11,"./lib/components/layer-notifier/layer-notifier":12,"./lib/components/subcomponents/layer-file-upload-button/layer-file-upload-button":24,"./lib/components/subcomponents/layer-send-button/layer-send-button":26,"./lib/handlers/message/layer-message-image/layer-message-image":28,"./lib/handlers/message/layer-message-text-plain":29,"./lib/handlers/message/layer-message-video":31,"./lib/handlers/text/autolinker":32,"./lib/handlers/text/code-blocks":33,"./lib/handlers/text/emoji":34,"./lib/handlers/text/images":35,"./lib/handlers/text/newline":36,"./lib/handlers/text/youtube":37,"./lib/layer-ui":38,"./lib/utils/date-separator":44,"./lib/utils/files":45}],2:[function(require,module,exports){
"use strict";
/**
...
},{"../base":5}],3:[function(require,module,exports){
"use strict";
/**
    ...
    libraryResult[className] = React.createClass({
      ...
      shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
        ...
        props.forEach(function (propDef) {
          ...
          if (nextProps[name] !== _this2.props[name]) {
            _this2.node[propDef.propertyName] = nextProps[name];
          }
        }, this);
        return false;
      },
...
},{"../base":5,"layer-websdk":59}],5:[function(require,module,exports){
"use strict";
/**
 * @class layerUI
 * @static
...
function finalizeMixinMerge(classDef) {
  ...
  propNames.forEach(function (name) {
    if (classDef['__' + name]) {
      var setters = classDef['__' + name].filter(function (def) {
        return def.set;
      });
      classDef['__set_' + name] = setters.map(function (def) {
        return def.set;
      });
    }
  });
  ...
  methodNames.forEach(function (methodName) {
    ...
    if (methodList.length === 1 && !methodDef.conditional.length) {
      ...
      classDef.methods[methodName] = function runMixinMethods() {
        var _this = this;
        ...
        var result = void 0;
        for (var i = 0; i < methodDef.conditional.length; i++) {
          if (!methodDef.conditional[i].apply(this, args)) return;
        }

        classDef['__method_' + methodName].forEach(function (method) {
  ...
  newDef.set = function propertySetter(value) {
    ...
    if (oldValue !== value || this.properties._internalState.inPropInit) {
      (function () {
        ...
        var wasInit = _this2.properties._internalState.inPropInit;
        _this2.properties._internalState.inPropInit = false;

        _this2.properties[name] = value;
        if (classDef['__set_' + name] && !_this2.properties._internalState.disableSetters) {
          classDef['__set_' + name].forEach(function (setter) {
            return setter.call(_this2, value, wasInit ? null : oldValue);
          });
        }
        _this2.properties._internalState.inPropInit = wasInit;
      })();
    }
  };
...
function registerComponent(tagName, classDef) {
  _base2.default.components[tagName] = classDef;
...
function _registerComponent(tagName) {
  var classDef = _base2.default.components[tagName];
  var template = classDef.template;
  delete classDef.template;
  var style = classDef.style;
  ...
  var noopMethods = ['onRerender'];
  noopMethods.forEach(function (methodName) {
  ...
  classDef.createdCallback = {
    value: function createdCallback() {
      ...
      _layerWebsdk2.default.Util.defer(function () {
        _this3.properties._internalState.disableSetters = false;
        _this3.properties._internalState.disableGetters = false;
        _this3.properties._internalState.inPropInit = true;
        props.forEach(function (prop) {
          var value = _this3.properties[prop.propertyName];
          ...
          if (value !== undefined && value !== null) {
            ...
            _this3[prop.propertyName] = value;
          }
        });
        _this3.properties._internalState.inPropInit = false;
        _this3.onAfterCreate();
      });
    }
  };
  ...
  classDef._initializeProperties = {
    value: function _initializeProperties() {
      ...
      props.forEach(function (prop) {
        return _this4._copyInAttribute(prop);
      });
    }
  };
  ...
  classDef.detachedCallback = {
    value: function detachedCallback() {
      ...
      setTimeout(function () {
        if (!document.body.contains(_this5) && !document.head.contains(_this5) && _this5.trigger('layer-widget-destroyed')) {
          _this5.onDestroy();
        }
      }, 10000);
    }
  ...
  _base2.default.components[tagName] = document.registerElement(tagName, {
   ...
   * @static
   */
  _base2.default.components[tagName].template = template;
   ...
   * @static
   */
  _base2.default.components[tagName].style = style;
...
var standardClassMethods = {
  ...
  onDestroy: function onDestroy() {
    ...
    this.properties._internalState.layerEventSubscriptions.forEach(function (subscribedObject) {
      return subscribedObject.off(null, null, _this7);
    });
...
},{"../base":5,"../mixins/state-manager":43,"layer-websdk":59}],7:[function(require,module,exports){
"use strict";
/**
...
},{"../../../../lib/base":5,"../../../components/component":6,"../../../mixins/list-item":40,"../../subcomponents/layer-avatar/layer-avatar":17,"../../subcomponents/layer-conversation-last-message/layer-conversation-last-message":20,"../../subcomponents/layer-conversation-title/layer-conversation-title":21,"../../subcomponents/layer-delete/layer-delete":23}],8:[function(require,module,exports){
"use strict";
/**
...
var Layer = _interopRequireWildcard(_layerWebsdk);
...
(0, _component.registerComponent)('layer-conversations-list', {
  mixins: [_list2.default, _mainComponent2.default],
  ...
  methods: {
     ...
     * @private
     */
    _getItemId: function _getItemId(conversation) {
      var uuid = conversation.id.replace(/^.*\//, '');
    ...
    _renderSelection: function _renderSelection() {
      ...
      var itemId = this.selectedConversationId ? this._getItemId({ id: this.selectedConversationId }) : null;
      var nodeToSelect = this.selectedConversationId ? this.querySelector('#' + itemId) : null;
      ...
      if (selectedNodes.length !== 1 || selectedNodes[0] !== nodeToSelect) {
        if (selectedNodes) {
          selectedNodes.forEach(function (node) {
            return node.removeClass('layer-conversation-item-selected');
          });
        }
...
},{"../../../../lib/base":5,"../../../components/component":6,"../../../mixins/list":41,"../../../mixins/main-component":42,"../layer-conversation-item/layer-conversation-item":7,"layer-websdk":59}],9:[function(require,module,exports){
"use strict";
/**
...
(0, _component.registerComponent)('layer-identities-list', {
    ...
    selectedIdentities: {
      set: function set(value) {
        ...
        this.properties.selectedIdentities = value.map(function (identity) {
          if (!(identity instanceof Layer.Identity)) return _this.properties.client.getIdentity(identity.id);
          return identity;
        });
        this._renderSelection();
      }
  ...
  methods: {
     ...
     * @param {String} id
     */
    _getItemId: function _getItemId(identity) {
    ...
    _renderSelection: function _renderSelection() {
      ...
      var selectedIds = this.selectedIdentities.map(function (identity) {
        return '#' + _this2._getItemId(identity);
      });
...
},{"../../../../lib/base":5,"../../../components/component":6,"../../../mixins/list":41,"../../../mixins/main-component":42,"../layer-identity-item/layer-identity-item":10,"layer-websdk":59}],10:[function(require,module,exports){
"use strict";
/**
...
(0, _component.registerComponent)('layer-identity-item', {
  ...
  methods: {
    ...
    _onChange: function _onChange(evt) {
      ...
      var customEventResult = this.trigger('layer-identity-item-' + (checked ? 'selected' : 'deselected'), { identity: identity });
...
},{"../../../../lib/base":5,"../../../components/component":6,"../../../mixins/list-item":40,"../../subcomponents/layer-avatar/layer-avatar":17,"layer-websdk":59}],11:[function(require,module,exports){
"use strict";
/**
        ...
        if (this.client && this.conversationId) {
          if (this.client.isReady && !this.client.isDestroyed) {
            ...
            this.client.once('ready', function () {
              if (_this.conversationId) _this.conversation = _this.client.getConversation(_this.conversationId, true);
            });
          }
        }
      }
...
},{"../../../lib/base":5,"../../components/component":6,"../../mixins/main-component":42,"../messages-list-panel/layer-messages-list/layer-messages-list":16,"../subcomponents/layer-composer/layer-composer":19,"../subcomponents/layer-typing-indicator/layer-typing-indicator":27,"layer-websdk":59}],12:[function(require,module,exports){
"use strict";
/**
...
(0, _component.registerComponent)('layer-notifier', {
  ...
  methods: {
    ...
    _notify: function _notify(evt) {
      ...
      if (type && type !== 'none') {
        if (this.trigger('layer-message-notification', { message: message, type: type, isBackground: isBackground })) {
      ...
      try {
        ...
        this.properties.desktopNotify = new Notify('Message from ' + message.sender.displayName, {
          ...
          notifyClick: function notifyClick() {
            window.focus();
            _this.trigger('layer-notification-click', { message: message });
...
},{"../../../lib/base":5,"../../base":5,"../../components/component":6,"../../mixins/main-component":42,"../subcomponents/layer-avatar/layer-avatar":17,"notifyjs":54}],13:[function(require,module,exports){
"use strict";
/**
...
},{"layer-websdk":59}],14:[function(require,module,exports){
"use strict";
'use strict';
...
var layerUI = require("../../../../lib/base");
layerUI.buildAndRegisterTemplate("layer-message-item-received", "<div class='layer-list-item' layer-id='innerNode'><div class='layer-message-body-and-avatar'><layer-avatar layer-id='avatar'></layer-avatar><div class='layer-message-item-main'><div class='layer-message-item-content' layer-id='content'></div></div></div><div class='layer-sender-info'><div class='layer-sender-name' layer-id='sender'></div><layer-date layer-id='date'></layer-date></div></div>", "");
...
},{"../../../../lib/base":5,"../../../components/component":6,"../../../mixins/list-item":40,"../../subcomponents/layer-avatar/layer-avatar":17,"../../subcomponents/layer-date/layer-date":22,"../layer-message-item-mixin":13}],15:[function(require,module,exports){
"use strict";
'use strict';
...
var layerUI = require("../../../../lib/base");
layerUI.buildAndRegisterTemplate("layer-message-item-sent", "<div class='layer-list-item' layer-id='innerNode'><div class='layer-message-body-and-avatar' layer-id='messageRow'><div class='layer-message-item-main'><div class='layer-message-item-content' layer-id='content'></div></div><div class='layer-avatar-delete-panel'><layer-avatar layer-id='avatar'></layer-avatar><layer-delete layer-id='delete'></layer-delete></div></div><div class='layer-sender-info layer-sender-details'><div class='layer-sender-name' layer-id='sender'></div><layer-message-status layer-id='status'></layer-message-status><layer-date layer-id='date'></layer-date></div></div>", "");
...
},{"../../../../lib/base":5,"../../../components/component":6,"../../../mixins/list-item":40,"../../subcomponents/layer-avatar/layer-avatar":17,"../../subcomponents/layer-date/layer-date":22,"../../subcomponents/layer-delete/layer-delete":23,"../../subcomponents/layer-message-status/layer-message-status":25,"../layer-message-item-mixin":13}],16:[function(require,module,exports){
"use strict";
/**
...
(0, _component.registerComponent)('layer-messages-list', {
  mixins: [_list2.default, _emptyList2.default],
  properties: {
  ...
  methods: {
    ...
    _checkVisibility: function _checkVisibility() {
      ...
      if (_base2.default.isInBackground()) return;
     ...
     * @private
     */
    _getItemId: function _getItemId(message) {
      var uuid = message.id.replace(/^.*\//, '');
    ...
    _renderWithoutRemovedData: {
      ...
      value: function value(evt) {
        ...
        var messageWidget = this.querySelector('#' + this._getItemId(evt.target));
    ...
    _renderInsertedData: {
      ...
      value: function value(evt) {
        ...
        if (insertIndex < oldListData.length) {
          var insertBeforeNode = affectedItems.length > 1 ? this.querySelector('#' + this._getItemId(oldListData[insertIndex])) : null;
    ...
    _updateLastMessageSent: function _updateLastMessageSent() {
      for (var i = this.properties.listData.length - 1; i >= 0; i--) {
        if (this.properties.listData[i].sender.sessionOwner) {
          var item = this.querySelector('#' + this._getItemId(this.properties.listData[i]));
    ...
    _renderPagedDataDone: function _renderPagedDataDone(affectedItems, fragment, evt) {
      ...
      if (affectedItems.length) {
        var affectedWidgetsQuery = '#' + affectedItems.map(function (message) {
          return _this7._getItemId(message);
        }).join(', #');
...
},{"../../../../lib/base":5,"../../../base":5,"../../../components/component":6,"../../../mixins/empty-list":39,"../../../mixins/list":41,"../layer-message-item-received/layer-message-item-received":14,"../layer-message-item-sent/layer-message-item-sent":15,"animated-scrollto":48,"layer-websdk":59}],17:[function(require,module,exports){
"use strict";
/**
...
},{"../../../../lib/base":5,"../../../components/component":6}],18:[function(require,module,exports){
"use strict";
/**
...
layerUI.buildStyle("layer-compose-button-panel", "layer-compose-button-panel {\ndisplay: flex;\nflex-direction: row;\nalign-items: stretch;\n}", "");

},{"../../../../lib/base":5,"../../../components/component":6}],19:[function(require,module,exports){
"use strict";
/**
...
(0, _component.registerComponent)('layer-composer', {
  ...
  methods: {
    ...
    send: function send(optionalParts) {
       ...
       */
      var textPart = message.parts.filter(function (part) {
      ...
      if (this.trigger('layer-send-message', { message: message, notification: notification })) {
    ...
    onRender: function onRender() {
      ...
      setTimeout(function () {
        ...
        var willBeOneLine = _this.nodes.resizer.clientHeight - _this.nodes.lineHeighter.clientHeight < 10;
...
var layerUI = require("../../../../lib/base");
layerUI.buildAndRegisterTemplate("layer-composer", "<div class='layer-compose-edit-panel' layer-id='editPanel'><div class='hidden-resizer' layer-id='resizer'>&nbsp;&nbsp;</div><div class='hidden-lineheighter' layer-id='lineHeighter'>&nbsp;</div><textarea rows=\"1\" autoFocus layer-id='input'></textarea></div><layer-compose-button-panel layer-id='buttonPanel'></layer-compose-button-panel>", "");
...
},{"../../../../lib/base":5,"../../../base":5,"../../../components/component":6,"../layer-compose-button-panel/layer-compose-button-panel":18,"layer-websdk":59}],20:[function(require,module,exports){
"use strict";
/**
...
},{"../../../../lib/base":5,"../../../base":5,"../../../components/component":6}],21:[function(require,module,exports){
"use strict";
/**
...
},{"../../../../lib/base":5,"../../../components/component":6}],22:[function(require,module,exports){
"use strict";
/**
...
},{"../../../../lib/base":5,"../../../components/component":6}],23:[function(require,module,exports){
"use strict";
/**
...
},{"../../../../lib/base":5,"../../../components/component":6,"layer-websdk":59}],24:[function(require,module,exports){
"use strict";
/**
  ...
  methods: {
    ...
    onCreate: function onCreate() {
      ...
      this.addEventListener('click', function (evt) {
        return _this.nodes.input.click();
      });
    },
...
},{"../../../../lib/base":5,"../../../base":5,"../../../components/component":6,"layer-websdk":59}],25:[function(require,module,exports){
"use strict";
/**
...
},{"../../../../lib/base":5,"../../../components/component":6,"layer-websdk":59}],26:[function(require,module,exports){
"use strict";
/**
     * The Layer file upload button widget allows users to select a File to send.
     *
...
},{"../../../../lib/base":5,"../../../components/component":6}],27:[function(require,module,exports){
"use strict";
/**
...
},{"../../../../lib/base":5,"../../../components/component":6}],28:[function(require,module,exports){
"use strict";
/**
...
},{"../../../../lib/base":5,"../../../base":5,"../../../components/component":6,"../../../utils/sizing":47,"blueimp-load-image/js/load-image":53,"blueimp-load-image/js/load-image-exif":50,"blueimp-load-image/js/load-image-meta":51,"blueimp-load-image/js/load-image-orientation":52}],29:[function(require,module,exports){
"use strict";
/**
...
(0, _component.registerComponent)('layer-message-text-plain', {
  ...
  methods: {
    ...
    render: function render() {
      ...
      this.innerHTML = textData.text + (textData.afterText.length ? startDiv + textData.afterText.join('</div>' + startDiv) + '</div>' : '');
    },
...
},{"../../base":5,"../../components/component":6}],30:[function(require,module,exports){
"use strict";
/**
...
},{"../../components/component":6}],31:[function(require,module,exports){
"use strict";
/**
...
},{"../../base":5,"../../components/component":6,"../../utils/sizing":47}],32:[function(require,module,exports){
"use strict";
/**
...
},{"../../base":5,"autolinker":49}],33:[function(require,module,exports){
"use strict";
/**
...
},{"../../base":5}],34:[function(require,module,exports){
"use strict";
/**
...
},{"../../base":5,"remarkable-emoji/setEmoji":56,"twemoji":57}],35:[function(require,module,exports){
"use strict";
/**
 * The Layer Image TextHandler replaces all image URLs with image tags
 *
...
},{"../../base":5,"../../utils/is-url":46}],36:[function(require,module,exports){
"use strict";
/**
...
},{"../../base":5}],37:[function(require,module,exports){
"use strict";
/**
...
},{"../../base":5}],38:[function(require,module,exports){
"use strict";
'use strict';
...
module.exports = _base2.default;
},{"./base":5,"./components/component":6,"./handlers/message/layer-message-unknown":30,"webcomponents.js/webcomponents-lite":58}],39:[function(require,module,exports){
"use strict";
/**
...
module.exports = {
  ...
  methods: {
    ...
    _generateFragmentItem: function _generateFragmentItem(item, fragment) {
      var itemInstance = item instanceof Layer.Root ? item : this.client.getObject(item.id);
      if (itemInstance) {
    ...
    _gatherAndProcessAffectedItems: function _gatherAndProcessAffectedItems(affectedItems, isTopItemNew) {
      ...
      if (affectedItems.length) {
        var itemIds = affectedItems.map(function (message) {
          return _this4._getItemId(message);
        });
    ...
    _renderWithoutRemovedData: function _renderWithoutRemovedData(evt) {
      ...
      var affectedItems = this.properties.listData.slice(Math.max(0, removeIndex - 3), removeIndex + 3);
      var listItem = this.querySelector('#' + this._getItemId(evt.target));
...
},{"../components/component":6,"layer-websdk":59}],42:[function(require,module,exports){
"use strict";
/**
...
module.exports = {
    ...
    appId: {
      set: function set(value) {
        if (value && value.indexOf('layer:///') === 0) {
          var client = Layer.Client.getClient(value);
  ...
  methods: {
     ...
     * @private
     */
    _scheduleGeneratedQuery: function _scheduleGeneratedQuery() {
...
},{"../base":5,"layer-websdk":59}],43:[function(require,module,exports){
"use strict";
/**
 * A helper mixin for Lists that render alternate text in the event that the list is Empty.
 *
...
},{"../base":5}],45:[function(require,module,exports){
"use strict";
/**
...
(function () {
  ...
  var Files = _base2.default.files = {};
  ...
  Files.DragAndDropFileWatcher.prototype.onDragOver = function (evt) {
    _this.node.classList.add('layer-file-drag-and-drop-hover');
    evt.preventDefault();
    return false;
  };
  ...
  Files.DragAndDropFileWatcher.prototype.onDragEnd = function (evt) {
    _this.node.classList.remove('layer-file-drag-and-drop-hover');
  };
  ...
  Files.DragAndDropFileWatcher.prototype.onFileDrop = function (evt) {
    ...
    Files.processAttachments(parts, _this.callback);
    return false;
  };
   ...
   */
  Files.processAttachments = function (parts, callback) {
  ...
  Files.generateImageMessageParts = function (part, callback) {
    ...
    function onWriteImage(srcCanvas) {
      ...
      var size = (0, _sizing2.default)(originalSize, _base.settings.maxSizes);
  ...
  Files.generateVideoMessageParts = function (part, callback) {
    var parts = [part];
...
},{"../base":5,"./sizing":47,"blueimp-load-image/js/load-image":53,"blueimp-load-image/js/load-image-exif":50,"blueimp-load-image/js/load-image-meta":51,"blueimp-load-image/js/load-image-orientation":52,"layer-websdk":59}],46:[function(require,module,exports){
"use strict";
'use strict';
...
},{"./load-image":53,"./load-image-meta":51}],51:[function(require,module,exports){
/*
...
},{"./load-image":53}],52:[function(require,module,exports){
/*
...
},{"./load-image":53}],53:[function(require,module,exports){
/*
...
},{"./emoji-map.js":55}],57:[function(require,module,exports){
(function (global){
